Create database Registro_itla1
use Registro_itla1
go
...
(
  ...
  ID_Aula varchar(50)--
    ...
    constraint fk_ID_Edificio foreign key (ID_Edificio) references Edificio(nombre_edificio),
    constraint ID_Aula foreign key (ID_Aula) references Aula(nombre_aula)
...
go
--- SP_Insertar
Alter Proc SP_InsertarVisitante
  @Nombre varchar(50),
  @Apellido varchar(50),
  @Carrera varchar(50),
  @Correo varchar(50),
...
go
--- SP_Actualizar
Alter Proc SP_ActualizarVisitant
  @Id int,
  @Nombre varchar(50),
  @Apellido varchar(50),
  @Carrera varchar(50),
...
------  Creacion de Stored procedure Aula
...
@nombre_edificio varchar(50)
as
Select Id, nombre_aula from Aula where ID_edificio_aula = @nombre_edificio
go

----  Foto  --------------------
Create Proc SP_BuscarVisitanteFoto
  @Buscar int
  AS
  Select Foto_visitante from Visitante
  Where Id = @Buscar
go
 ...
 Create Proc SP_BuscarVisitanteEdificio
  @Buscar varchar(50)
  AS
  Select * from Visitante
  Where ID_Edificio Like @Buscar + '%'
